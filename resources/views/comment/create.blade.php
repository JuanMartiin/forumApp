                ...
                <div class="card mb-2 m-auto" style="width:700px; height:430px;">
                    <div class="card-body p-2 p-sm-3" >
                        <form action="{{ url('comment') }}" method="post">
                            ...
                            <div class="p-t-15">
                                <button class="btn btn-info bg-secondary btn-lg btn-block mt-5" type="submit" style="width:100px; float:left">
                                    <a style="list-style-type:none; color:white">Add</a>
                                </button>
                                <div class="btn btn-info bg-secondary btn-lg btn-block mt-5" style="width:100px; float:left; margin-left:10px">
